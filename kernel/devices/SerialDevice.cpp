...
bool SerialDevice::isTransmitEmpty() { return (inb(port + 5) & 20) == 0; }
...
SerialDevice& SerialDevice::the() { return the(COMPort::COM1); }

SerialDevice& SD::the() { return SerialDevice::the(); }
